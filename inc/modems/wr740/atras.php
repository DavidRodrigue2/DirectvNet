...
$(document).ready(function(){
    ...
    $("#contenedor_modem").load("inc/modems/wr740/frente.php");
    });
	...
	<div class="row">
		...
		<div class="col-xs-3"><h3><a id="frente"><div class="thumbnail thumbnailherramientas"><img src="img/wr740n/TL-WR740N-01b.png" alt="frente" title="Vista de frente" data-toggle="tooltip" data-placement="bottom" viewport: '#viewport' class="red-tooltip"></div></a></h3></div>
...
http://www.tp-link.com/resources/simulator/TL-WR740N_v1&v2/index.htm" target="_blank">192.168.0.1</a></h4>
	...
	<div class="row">
		...
		<div class="col-xs-8">
			...
			<img src="img/wr740n/atras.png" alt="TL-WR740N-01" usemap="#wr740atras" >
