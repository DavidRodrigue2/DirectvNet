...
<link href="inc/modems/wr740/estilo.css" rel="stylesheet">
...
$(document).ready(function(){
    $('[data-toggle="tooltip"]').tooltip();
   	...
   	$(".botondesc").click(function(){
		...
		$("#carga").load("inc/modems/wr740/descripcion.php?boton="+boton);
    });
    ...
    $("#contenedor_modem").load("inc/modems/wr740/atras.php");
    });
	...
	<div class="row">
		...
		<div class="col-xs-7"><h1>TP LINK TL WR740N: vista de frente</h1></div>
		<div class="col-xs-3"><h3><a id="atras"><div class="thumbnail thumbnailherramientas"><img src="img/wr740n/TL-WR740N(UN_5.0_06b.png" alt="atras" title="Vista de atras" data-toggle="tooltip" data-placement="bottom" viewport: '#viewport' class="red-tooltip"></div></a></h3></div>
...
http://www.tp-link.com/resources/simulator/TL-WR740N_v1&v2/index.htm" target="_blank">192.168.0.1</a></h4>
	...
	<div class="row">
		...
		<div class="col-xs-8">
			...
			<img src="img/wr740n/TL-WR740N-01c.png" alt="TL-WR740N-01" usemap="#wr740" >
