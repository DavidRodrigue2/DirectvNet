...
$(document).ready(function(){
    ...
    $("#contenedor_modem").load("inc/modems/arcadyan/atras.php");
    });
	...
	<div class="row">
		...
		<div class="col-xs-7"><h1>ARCADYAN: vista de frente</h1></div>
		<div class="col-xs-3"><h3><a id="atras"><div class="thumbnail thumbnailherramientas"><img src="img/arcadyan/miniarcadyanatras.png" alt="atras" title="Vista de atras" data-toggle="tooltip" data-placement="bottom" viewport: '#viewport' class="red-tooltip"></div></a></h3></div>
	...
	<div class="row">
		...
		<div class="col-xs-8">
			...
			<img src="img/arcadyan/arcadyanfrente.png" alt="ARCADYAN" usemap="#arcadyan" >
