...
$(document).ready(function(){
    $('[data-toggle="tooltip"]').tooltip();
   	...
   	$(".botondesc").click(function(){
   		...
   		$("#carga").load("inc/modems/arcadyan/descripcion.php?boton="+boton);
    });
    ...
    $("#contenedor_modem").load("inc/modems/arcadyan/frente.php");
    });
	...
	<div class="row">
		...
		<div class="col-xs-7"><h1>TP LINK TL WR740N: vista de atras</h1></div>
		<div class="col-xs-3"><h3><a id="frente"><div class="thumbnail thumbnailherramientas"><img src="img/arcadyan/miniarcadyanfrente.png" alt="frente" title="Vista de frente" data-toggle="tooltip" data-placement="bottom" viewport: '#viewport' class="red-tooltip"></div></a></h3></div>
	
		<div class="col-xs-8 col-xs-offset-4">
			<h4>SIMULADOR GUI: 	<a href="inc/simuladoresModems/simulador_arcadyan/192.168.100.1.html" target="_blank">192.168.100.1</a></h4>
		</div>
	...
	<div class="row">
		...
		<div class="col-xs-8">
			...
			<img src="img/arcadyan/atras.png" alt="TL-WR740N-01" usemap="#wr740atras" >
